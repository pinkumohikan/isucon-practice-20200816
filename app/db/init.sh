...
mysql -uisucon torb -e 'ALTER TABLE reservations ADD KEY (user_id)'
mysql -uisucon torb -e 'CREATE INDEX reservations_event_id_and_canceled_at_sheet_id_idx ON reservations (event_id,canceled_at,sheet_id)'
